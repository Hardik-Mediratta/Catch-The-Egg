...
textSize(25)
text("(Move arrows to move basket to catch eggs)", 450,50)
...
//text(mouseX+","+mouseY,mouseX,mouseY);
    ...
    if(egg1.isTouching(ground)){
      textSize(50)
        text("GAME OVER",575,325)
        clearAll();
  }

  if(egg2.isTouching(ground)){
    textSize(50)
    text("GAME OVER",575,325)
    clearAll();
}

if(egg3.isTouching(ground)){
  textSize(50)
  text("GAME OVER",575,325)
  clearAll();
}

if(egg4.isTouching(ground)){
  textSize(50)
  text("GAME OVER",575,325)
  clearAll();
}

if(egg5.isTouching(ground)){
  textSize(50)
  text("GAME OVER",575,325)
  clearAll();
}

if(egg6.isTouching(ground)){
  textSize(50)
  text("GAME OVER",575,325)
  clearAll();
}

if(egg7.isTouching(ground)){
  textSize(50)
  text("GAME OVER",565,325)
  clearAll();
}
